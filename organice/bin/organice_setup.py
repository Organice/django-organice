...
def startproject():
    ...
    settings.save_files()
    replace_project_files(projectname)
...
TEMPLATE_URLS_PY = """# generated by django Organice
...
def replace_project_files(projectname):
    """Very dirty quick configuration of project's ``urls.py`` file"""
    print('Configuring project URLs ...')
    urls_py = open(os.path.join(projectname, 'urls.py'), 'w')
    urls_py.write(TEMPLATE_URLS_PY)
    urls_py.close()
